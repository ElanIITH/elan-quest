...
export default function SyllabusPage() {
  ...
  const currentClassSyllabus = syllabusData
    ? syllabusData[selectedClass]
    : null;
  const subjects = currentClassSyllabus
    ? Object.keys(currentClassSyllabus)
    : [];
    ...
    <>
      <div className="w-full h-full min-h-screen bg-neutral-800 overflow-hidden pb-20">
        <div className="max-w-5xl mx-auto px-4 py-8 text-justify">
          <span className="text-lime-100 text-2xl font-light font-['Raleway']">
            Nexus QUEST spans four key academic areas -{" "}
          </span>
          <span className="text-lime-100 text-2xl font-medium font-['Raleway']">
            Logical
          </span>
          <span className="text-lime-100 text-2xl font-light font-['Raleway']">
            {" "}
          ...
          <span className="text-lime-100 text-2xl font-light font-['Raleway']">
            testing students theoretical knowledge, problem-solving
            capabilities, and real-world application of basic concepts. The
            examination balances curriculum-aligned topics with analytical
            reasoning, delivering a complete evaluation of scholarly performance
          ...
          {syllabusData &&
            Object.keys(syllabusData).map((className) => (
              <button
                ...
                className={`w-40 h-12 flex items-center justify-center text-lg font-medium font-['Raleway'] ${
        ...
        <div className="max-w-5xl mx-auto px-4 py-8 bg-lime-100 rounded-lg">
          <h2 className="text-neutral-800 text-3xl font-bold font-['Raleway'] mb-4">
            Syllabus for {selectedClass.replace("CLASS ", "Class ")}
          </h2>

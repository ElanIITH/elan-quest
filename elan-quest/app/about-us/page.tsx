  ...
  return (
    <div className={`${raleway.className} bg-[#252525] text-[#E8E8C6] pt-16 w-full overflow-x-hidden`}>
      <div className="space-y-20">
        ...
        {/* ABOUT US */}
        <motion.div initial="hidden" animate="visible" variants={fadeInUp} custom={0} className="px-6 md:px-20">
          <motion.div variants={fadeInUp} custom={1} className="w-full max-w-[700px] h-[90px]">
            <AboutUs />
          </motion.div>
          <motion.div variants={fadeInUp} custom={2} className="w-full max-w-[1050px] h-[80px] mt-6">
            <AboutNexus />
          </motion.div>
          <motion.p variants={fadeInUp} custom={3} className="mt-6 text-[20px] leading-relaxed text-justify">
        ...
        <motion.div initial="hidden" animate="visible" variants={fadeInUp} custom={4} className="px-6 md:px-20">
          ...
          {/* Link + Hover Arrows */}
          <motion.div variants={fadeInUp} custom={6} className="flex justify-end w-full mt-2">
            <a
        ...
        {/* ABOUT IIT HYDERABAD */}
        <motion.div initial="hidden" animate="visible" variants={fadeInUp} custom={7} className="px-6 md:px-20">

      ...
      <div className="max-w-5xl mx-auto space-y-20">
        ...
        <div>
          ...
          <div className="flex justify-end w-full mt-2">
            ...
            >
              <span className="text-sm italic underline">visit elan.org.in</span>
              <div className="flex items-center gap-1 w-[50px] opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                <SingleLink />
                <SingleLink />
              </div>
            </a>
